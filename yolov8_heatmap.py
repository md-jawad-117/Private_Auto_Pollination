...
class yolov8_heatmap:
    ...
    def __call__(self, img_path, save_path):
        ...
        if os.path.isdir(img_path):
            ...
            self.process(img_path, f'{save_path}/eg1.png')
        
def get_params():
    params = {
        'weight': 'E:/Research_Papers/Autonomous Pollination/yolo/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'E:/Research_Papers/Autonomous Pollination/Resource/Heatmap Image/1.jpg', 'result')